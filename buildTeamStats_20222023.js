...
async function getTeamStats() {
    ...
    const nhl_team_stats_url = `https://statsapi.web.nhl.com/api/v1/standings?hydrate=record(overall),division,conference,team(nextSchedule(team),previousSchedule(team))&season=20222023&site=en_nhl`
    const teamStatsFilePath = 'Reports/HockeyReports/GameReports/02_NHLTeamStats.json'
